...
**Client Login Verification (Test ID: SL_01_ClientLogin)**

* **Tester Name:** Antonio Almero
* **Date of Execution:** June 26, 2026
* **Module / Screen Under Test:** Client Login Screen & OTP Verification Screen
* **Objective:** To test if registered clients can log in to the system.
